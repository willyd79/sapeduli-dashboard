...
var _hoisted_19 = ["aria-label", "aria-current", "onClick", "data-p-highlight"];
function render$3(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("span", mergeProps({
    ...
    }), [createTextVNode(toDisplayString(pageLink), 1)], 16, _hoisted_19)), [[_directive_ripple]]);
  }), 128))], 16);
}
    ...
    onChange: function onChange4(event2) {
      ...
      if (!this.disabled && !this.readonly) {
        ...
        if (this.binary) {
          ...
          else newModelValue = this.modelValue ? [].concat(_toConsumableArray3(this.modelValue), [this.value]) : [this.value];
        }
...
var _hoisted_113 = ["data-p-highlight", "data-p-disabled"];
...
var _hoisted_114 = ["data-p-highlight", "data-p-disabled"];
...
function render15(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", mergeProps({
    ...
    "class": _ctx.cx("icon")
  }, $options.getPTOptions("icon")), null, 16)], 16)], 16, _hoisted_114);
}
...
var _hoisted_5 = [_hoisted_119, _hoisted_218, _hoisted_3, _hoisted_4];
...
var _hoisted_122 = ["tabindex", "colspan", "rowspan", "aria-sort", "data-p-sortable-column", "data-p-resizable-column", "data-p-highlight", "data-p-filter-column", "data-p-frozen-column", "data-p-reorderable-column"];
  ...
  methods: {
    ...
    exportCSV: function exportCSV(options, data13) {
      ...
      if (!data13) {
        ...
        else if (this.frozenValue) data13 = data13 ? [].concat(_toConsumableArray4(this.frozenValue), _toConsumableArray4(data13)) : this.frozenValue;
      }
